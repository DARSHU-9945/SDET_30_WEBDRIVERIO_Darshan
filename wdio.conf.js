...
//let CommnData=require("./test/Data/CommonData")
//let TestDta=require("./test/Data/SpecificData")
...
exports.config = {
     ...
     */
     before: function (capabilities, specs) {
        global.assert = require('chai').assert      // import assert from chai library(assert styles)
        // var expect = require('chai').expect
        global.should = require('chai').should()    // import assert from chai library(assert styles)
        console.log("open the browser and enter the url");
        require('expect-webdriverio');
        global.wdioExpect = global.expect;   // import it from webdriverIo==>Assertions==>global==>code
        const chai = require('chai');
        global.expect = chai.expect;   // import it from webdriverIo==>Assertions==>global==>code

        //custom commands==>we are creating Custom Conditions Here (getting both url and title)
     ...
     */
     beforeTest:async function (test, context) {
        ...
        await lp.loginToApplication(excelArray[0].url,excelArray[0].userName,excelArray[0].Password)
